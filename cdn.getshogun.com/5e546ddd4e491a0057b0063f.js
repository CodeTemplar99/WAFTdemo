...
;(function($) {
  ...
  $('.triggerM').click(function() {
    var youtube = $(this).data('id');
    var modal = $(this).next('.modal');
    document.body.classList.add('stop-scroll');
    modal.closest('.shg-box-content').css('z-index', zIdxCounter);
    if (modal.parents('.shg-box-content').length > 1) {
      // to fix if shg-box-content is within a parent shg-box-content
      modal.parents('.shg-box-content').last().css('z-index', zIdxCounter);
    }
    zIdxCounter++;
    modal.show();
    modal.find('iframe').attr({'src': "https://www.youtube.com/embed/" + youtube + "?autoplay=1&showinfo=0&modestbranding=1&rel=0&wmode=opaque"});
...
//     var modal = $(this).next('.modal');
//     document.body.classList.add('stop-scroll');
//     modal.closest('.shg-box-content').css('z-index', 999);
//     modal.show();
//     modal.find('iframe').attr({'src': "https://www.youtube.com/embed/" + youtube + "?autoplay=1&showinfo=0&modestbranding=1&rel=0&wmode=opaque"});
//   })
...
// jQuery('.triggerM').click(function() {
//   var youtube = jQuery(this).data('id');
...
// jQuery('.triggerW').click(function() {
//   var youtube = jQuery(this).data('id');
//   var modal = jQuery(this).next('.modal');
//   document.body.classList.add('stop-scroll');
//   modal.closest('.shg-box-content').css('z-index', zIdxCounter);
...
// function windowOnClick(event) {
//   if ($(event.target).attr("class") === 'modal1') {
//     hideModal();
//   }
// }

...
(function($){
  ...
  theme.headerNav = (function() {
    ...
    function init() {
      ...
      if (theme.settings.overlayHeader && !theme.settings.collectionImage) {
  ...
  theme.Collection = (function() {
    ...
    function Collection(container) {
      ...
      theme.settings.collectionImage = $heroImageContainer.length;
      if ($heroImageContainer.length) {
        this.checkIfNeedReload();
        theme.loadImageSection($heroImageContainer);
      } else if (theme.settings.overlayHeader) {
        theme.headerNav.disableStickyHeader();
      }
  ...
  theme.pageTransitions = function() {
    if ($('body').data('transitions') == true) {
      ...
      $('a[href^="mailto:"], a[href^="#"], a[target="_blank"], a[href*="youtube.com/watch"], a[href*="youtu.be/"], .shg-btn').each(function() {
